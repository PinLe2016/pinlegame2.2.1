...
//char* MD5::GenerateMD5(const string& s,int bufferlen)
//{
//    struct md5_context context;
//    md5_starts (&context);
//    md5_update (&context, (unsigned char*)s.c_str(), bufferlen);
...
char* MD5::GenerateMD5(const string& s,int bufferlen)
{
    MD5 MD5;
    struct md5_context context;
    MD5.md5_starts (&context);
    MD5.md5_update (&context, (unsigned char*)s.c_str(), bufferlen);
    MD5.md5_finish (&context,(unsigned char*)MD5.m_data);
    return MD5.ToString();
}
...
{
    memcpy(m_data,md5src,sizeof(long));
}
