...
namespace Cocos
{
	...
	public:
         ...
         * @return  none
         */
        static void setDevPlatForm(bool isDev);
         ...
         * @param content			文本内容
         */
        static void sendImMsg(const std::string& sendAccount,
                              const std::string& receiverAccount,
    ...
    public:
         ...
         */
        static void setDebugMode(bool isDebugModel);
        /**
         *  统计
         *
	...
	public:
         ...
         * 发送IM消息
         */
        virtual void onSendImMsg(int retCode, const std::string& retMsg){};
        #endif
